...
describe("workPreferenceUtils", () => {
  describe("isValidTimeFormat", () => {
    ...
    it("should return false for invalid minutes 09:60", () => {
      expect(isValidTimeFormat("09:60")).toBe(false);
    });

    it("should return false for non-time string", () => {
      expect(isValidTimeFormat("invalid")).toBe(false);
    });

    it("should return false for partial time 9:00", () => {
  ...
  describe("validateWorkPreferences", () => {
    ...
    it("should return empty errors when all fields are valid", () => {
    ...
    it("should return multiple errors for invalid time and notes", () => {
      const preferences: WorkPreferences = {
        workSchedule: "",
        workLocation: "",
    ...
    it("should not return error for notes exactly 500 characters", () => {
      const preferences: WorkPreferences = {
        workSchedule: "",
        workLocation: "",
        preferredStartTime: "",
