      ...
      >
        ...
        {isDrawerExpanded && (
          <Stack sx={classes.footer}>
            <Button size={"sm"} fullWidth={false} variant={"tertiary"} onClick={handleOpenSubmitRequestModal} data-testid={appDrawerTestId.getHelpLink}>{translateText(["getHelp"])}</Button>
