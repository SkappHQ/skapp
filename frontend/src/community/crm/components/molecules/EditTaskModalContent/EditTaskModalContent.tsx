...
const EditTaskModalContent: FC = () => {
  ...
  useEffect(() => {
    setSelectedOwner(selectedTask?.owner ?? null);
    setSelectedContactName(selectedTask?.contact?.name ?? "");
  ...
  const initialValues: CrmTaskEditFormTypes = {
  ...
  const submitEditTask = (formValues: CrmTaskEditFormTypes) => {
    ...
    <div className="flex flex-col w-full h-full justify-between gap-[0.625rem]">
      ...
      <div className="flex flex-row justify-end py-[0.85rem] gap-[1rem]">
        ...
        <ButtonV2
          ...
          type="button"
          onClick={submitForm}
          disabled={!selectedTask || isSubmitting || isPending}
