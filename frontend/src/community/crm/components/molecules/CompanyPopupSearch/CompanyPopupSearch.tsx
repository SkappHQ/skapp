...
import { CrmCompanyLookupType } from "~community/crm/types/CommonTypes";

interface Props {
  companies: CrmCompanyLookupType[];
  selectedCompany: CrmCompanyLookupType | null;
  onChange: (company: CrmCompanyLookupType | null) => void;
  placeholder?: string;
