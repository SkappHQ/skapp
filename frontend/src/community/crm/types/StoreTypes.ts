import { CrmCompanyMetricsType, CrmContactMetricsType, CrmTaskType } from "./CommonTypes";
...
interface ActionTypes {
  ...
  setSelectedTask: (selectedTask: CrmTaskType | null) => void;
}
