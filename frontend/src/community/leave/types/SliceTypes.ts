...
export interface LeaveAllocationModalSliceType extends Pick<
  LeaveStore,
...
export interface LeaveTypeSliceType extends Pick<
  LeaveStore,
  | "allLeaveTypes"
  | "pendingNavigation"
...
export interface LeaveEntitlementSliceType extends Pick<
  LeaveStore,
  ...
  | "setPage"
> {}
export interface LeaveCarryForwardModalSliceType extends Pick<
  LeaveStore,
...
export interface NewPendingLeaveCountSliceType extends Pick<
  LeaveStore,
...
export interface addNewEntitlementsSliceType extends Pick<
  LeaveStore,
  | "leaveTypes"
  | "setLeaveTypes"
...
export interface MyRequestSliceType extends Pick<
  LeaveStore,
...
export interface LeaveRequestFiltersSliceTypes extends Pick<
  LeaveStore,
  | "leaveRequestsFilter"
...
export interface LeaveRequestDataSliceTypes extends Pick<
  LeaveStore,
  "leaveRequestData" | "setLeaveRequestData" | "removeLeaveRequestRowData"
> {}

export interface LeaveRequestModalSliceTypes extends Pick<
  LeaveStore,
  | "isManagerModalOpen"
  | "isEmployeeModalOpen"
  | "setIsManagerModal"
...
export interface NewLeaveIdSliceTypes extends Pick<
  LeaveStore,
  "newLeaveId" | "setNewLeaveId" | "removeNewLeaveId"
> {}

export interface EmployeeLeaveRequestDataSliceTypes extends Pick<
  LeaveStore,
...
export interface TeamLeaveAnalyticSliceTypes extends Pick<
  LeaveStore,
