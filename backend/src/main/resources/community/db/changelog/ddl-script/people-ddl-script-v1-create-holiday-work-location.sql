...
(
    ...
    CONSTRAINT `FK_holiday_work_location_holiday_id` FOREIGN KEY (`holiday_id`) REFERENCES `holiday` (`id`) ON DELETE CASCADE,
    CONSTRAINT `FK_holiday_work_location_com_work_location_id` FOREIGN KEY (`work_location_id`) REFERENCES `com_work_location` (`id`) ON DELETE CASCADE
);
