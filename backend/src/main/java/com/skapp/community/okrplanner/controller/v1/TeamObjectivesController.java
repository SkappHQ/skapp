...
public class TeamObjectivesController {
	...
	@GetMapping
	public ResponseEntity<ResponseEntityDto<List<TeamObjective>>> getTeamObjectives(@RequestParam Long teamId,
			@RequestParam Long effectiveTimePeriod) {
		//TODO: ADD optional team title pagination
		ResponseEntityDto<List<TeamObjective>> response = teamObjectiveService
