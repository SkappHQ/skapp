...
public class EmployeeTimeRecordImpl implements EmployeeTimeRecord {
    ...
    public EmployeeTimeRecordImpl(Long timeRecordId, Long employeeId, LocalDate date,
                                  Float workedHours, Float breakHours, String timeSlots) {
    ...
    @Override public Long getTimeRecordId() { return timeRecordId; }
    @Override public Long getEmployeeId() { return employeeId; }
    @Override public LocalDate getDate() { return date; }
    @Override public Float getWorkedHours() { return workedHours; }
    @Override public Float getBreakHours() { return breakHours; }
    @Override public String getTimeSlots() { return timeSlots; }
}