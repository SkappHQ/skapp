...
public enum CrmMessageConstant implements MessageConstant {
	...
	CRM_ERROR_CONTACT_FIRST_NAME_REQUIRED("api.error.crm.contact-first-name-required"),
	CRM_ERROR_CONTACT_FIRST_NAME_TOO_LONG("api.error.crm.contact-first-name-too-long"),
	CRM_ERROR_CONTACT_FIRST_NAME_INVALID("api.error.crm.contact-first-name-invalid"),
	CRM_ERROR_CONTACT_LAST_NAME_TOO_LONG("api.error.crm.contact-last-name-too-long"),
	CRM_ERROR_CONTACT_LAST_NAME_INVALID("api.error.crm.contact-last-name-invalid"),
