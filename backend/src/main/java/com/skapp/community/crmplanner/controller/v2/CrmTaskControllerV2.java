...
public class CrmTaskControllerV2 {
	...
	@Operation(summary = "Get related tasks",
			description = "Returns a paginated list of tasks related to the given task - i.e. tasks that share the "
					+ "source task's company, deal or contact. Supports pagination only (size < 0 disables "
					+ "pagination and returns every related task).")
