...
public enum LeaveMessageConstant implements MessageConstant {
	...
	LEAVE_ERROR_BULK_EMPLOYEE_EMAIL_REQUIRED("api.error.leave.bulk-employee-email-required"),
	LEAVE_ERROR_BULK_EMPLOYEE_NOT_FOUND("api.error.leave.bulk-employee-not-found"),
	LEAVE_ERROR_BULK_POLICY_ID_REQUIRED("api.error.leave.bulk-policy-id-required"),
	LEAVE_ERROR_BULK_INVALID_POLICY_ID("api.error.leave.bulk-invalid-policy-id"),
	LEAVE_ERROR_BULK_POLICY_NOT_FOUND("api.error.leave.bulk-policy-not-found"),
	LEAVE_ERROR_BULK_POLICY_INACTIVE("api.error.leave.bulk-policy-inactive"),
