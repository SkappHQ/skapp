		...
		http.csrf(AbstractHttpConfigurer::disable)
			...
			.authorizeHttpRequests(auth -> auth
				...
				.requestMatchers("/v1/auth/**", "/v3/api-docs/**", "/v3/api-docs", "/v3/api-docs.yaml",
						...
						"/v1/ep/auth/domain/verify", "/v1/ep/tenant/create", "/health", "/deployment",
						...
						"/v1/ep/esign/document-link/verify-otp", "/external/adms/*/iclock/cdata",
						"/external/adms/*/iclock/getrequest")
				.permitAll()
