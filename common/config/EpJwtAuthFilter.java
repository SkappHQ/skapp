...
public class EpJwtAuthFilter extends OncePerRequestFilter {
	...
	private static final Set<String> PUBLIC_URLS = Set.of("/v3/api-docs", "/v3/api-docs.yaml", "/swagger-ui.html",
			...
			"/v1/ep/stripe/webhook", "/v1/ep/esign/document-link/access", "/v1/ep/esign/documents/sign",
			"/v1/ep/esign/documents/sign-field", "v1/ep/esign/envelopes/signature-certificate");
