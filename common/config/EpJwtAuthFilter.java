...
public class EpJwtAuthFilter extends OncePerRequestFilter {
	...
	private static final Set<String> PUBLIC_URLS = Set.of("/v3/api-docs", "/v3/api-docs.yaml", "/swagger-ui.html",
			...
			"/robots.txt", "/health", "/deployment", "/v1/ep/organization/login-method", "/v1/ep/auth/password-reset",
			"/v1/ep/auth/password-reset/verify-otp", "/v1/ep/auth/password-reset/send-otp",
			"/v1/ep/auth/password-reset/resend-otp", "/v1/auth/refresh-token", "/v1/ep/auth/tenant/availability",
			"/v1/google-calendar/redirect", "/v1/validate/email", "/v1/ep/stripe/webhook",
			"/v1/ep/esign/document-link/access", "/v2/ep/auth/sso/google/auth-url", "/v2/ep/auth/sso/google/redirect",
			"/v2/ep/auth/signin/sso/google", "/v2/ep/auth/signup/super-admin/sso/google",
			"/v1/ep/auth/code-challenge/verify", "/v1/ep/esign/documents/sign", "/v1/ep/esign/documents/sign-field",
			"/v1/ep/esign/envelopes/decline", "/v1/ep/esign/envelopes/signature-certificate",
			"/v1/ep/esign/recipients/consent", "/v2/ep/auth/sso/microsoft/auth-url",
			"/v2/ep/auth/sso/microsoft/redirect", "/v2/ep/auth/signup/super-admin/sso/microsoft",
			"/v2/ep/auth/signin/sso/microsoft", "/v1/ep/esign/document-link/resend", "/v1/ep/esign/audit-trial/create",
			...
			"/internal/v1/ep/user/guest", "/internal/v1/ep/ai/prompt-log", "/internal/v1/ep/ai/prompt-log/message");
