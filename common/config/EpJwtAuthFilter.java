...
public class EpJwtAuthFilter extends OncePerRequestFilter {
	...
	private static final Set<String> PUBLIC_URLS = Set.of("/v3/api-docs", "/v3/api-docs.yaml", "/swagger-ui.html",
			...
			"/v1/ep/stripe/webhook", "/v1/ep/esign/document-link/access", "/v2/ep/auth/signin/sso/google/auth-url",
			"/v2/ep/auth/signin/sso/google/redirect", "/v2/ep/auth/signin/sso/google",
			"/v2/ep/auth/signup/super-admin/sso/google", "/v1/ep/auth/code-challenge");
