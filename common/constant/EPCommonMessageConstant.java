...
public enum EPCommonMessageConstant implements MessageConstant {
	...
	EP_COMMON_ERROR_INVALID_GUEST_USER_APPROVAL_STATUS("ep.common.error.invalid-guest-user-approval-status"),
	...
	EP_COMMON_ERROR_ANNOUNCEMENT_NOT_FOUND("ep.common.error.announcement-not-found"),
	...
	EP_COMMON_ERROR_ANNOUNCEMENT_CTA_LINK_MUST_BE_RELATIVE(
			"ep.common.error.announcement-cta-link-must-be-relative"),
